...
static NSString *const AWSCognitoSDKVersion = @"2.6.17";
...
static AWSKeyChainStore *keychain = nil;
...
+ (void)initialize {
    ...
    keychain = [AWSKeyChainStore keyChainStoreWithService:[NSString stringWithFormat:@"%@.%@", [NSBundle mainBundle].bundleIdentifier, [AWSCognito class]]];
